...
### モダンファイルマネージャー
- 統合ワークスペース: フォルダとファイルを分断せず、同じグリッドまたはリストで表示
- グリッド/リスト表示: フォルダを含むコンテンツ全体のビュー切り替え
- 高度な検索・ソート: フォルダ名、ファイル名、コメントのリアルタイム検索と複数のソートオプション
...
- 統合ヘッダー: アップローダーのタイトル、説明、関連リンクを常時確認できるアプリヘッダーに集約

### フォルダ管理システム
- 階層フォルダ: ネストしたフォルダ構造の作成・管理
- フォルダナビゲーション: ページ再読み込みのないパンくずナビと、ブラウザの戻る・進む操作に対応
- 設定可能な深度: カスタマイズ可能な最大フォルダ深度と制限

### 高度なアップロード機能
- ドラッグ＆ドロップアップロード: ワークスペース全体へのドロップと複数ファイル選択に対応
