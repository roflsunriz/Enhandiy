...
## [4.3.7-roflsunriz] - 2025-08-28

### Fixed

- フォルダのルートに戻ったとき?folder=が残らないようにした

## [4.3.6-roflsunriz] - 2025-08-28
...
## [4.3.5-roflsunriz] - 2025-08-28

### Fixed

- 共有モーダルの共有内容表示テキストエリアのIDをshareUrlTextFieldに変更
- UIからの正規アクセス（CSRFトークン付与）で/api/foldersおよび/api/filesがAPI_KEY_MISSINGを返さないようにした
...
## [4.3.1-roflsunriz] - 2025-08-26

### Fixed

- tus-upload.phpのLocationヘッダーが正しく生成されない問題を修正
- resumeable-upload.tsのエラーキャッチを堅牢化
