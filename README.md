...
phpUploader v4.2.4-roflsunriz は、以下のような用途に最適化されています：
...
**Full Changelog**: <https://github.com/roflsunriz/phpUploader/compare/v1.0.0...v4.2.4-roflsunriz>
