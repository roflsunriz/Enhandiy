...
try {
    ...
    if (file_exists(__DIR__ . '/../../backend/config/config.php.example')) {
        ...
        copy(__DIR__ . '/../../backend/config/config.php.example', __DIR__ . '/../../backend/config/config.php.test');
        include __DIR__ . '/../../backend/config/config.php.test';
        ...
        unlink(__DIR__ . '/../../backend/config/config.php.test');
    } else {
